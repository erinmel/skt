...
public static class IconMapper
{
    ...
    private static readonly Dictionary<string, string> ExtIcons = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [".gif"] = "Icon.Image", [".svg"] = "Icon.Image",
        [".ico"] = "Icon.Favicon",
        [".htm"] = "Icon.Html", [".html"] = "Icon.Html",
        [".js"] = "Icon.Javascript", [".mjs"] = "Icon.Javascript", [".cjs"] = "Icon.Javascript",
        [".csv"] = "Icon.Table", [".tsv"] = "Icon.Table",
        [".ttf"] = "Icon.Font", [".otf"] = "Icon.Font", [".woff"] = "Icon.Font", [".woff2"] = "Icon.Font",
        [".db"] = "Icon.Database", [".sqlite"] = "Icon.Database",
        [".zip"] = "Icon.Zip", [".gz"] = "Icon.Zip", [".tar"] = "Icon.Zip", [".7z"] = "Icon.Zip",
        [".mp3"] = "Icon.Audio", [".wav"] = "Icon.Audio",
        [".mp4"] = "Icon.Video", [".mov"] = "Icon.Video",
        [".skt"] = "Icon.SktFile",
        [".dll"] = "Icon.Assembly", [".exe"] = "Icon.Assembly",
    };
